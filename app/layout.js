      ...
      <section style={{ padding: '50px 20px 24px 20px', textAlign: 'center', maxWidth: '1000px', margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: '16px' }}>
          <img 
            ...
            style={{ height: '80px', width: 'auto', margin: '0 auto', display: 'inline-block' }}
          />
        </div>

        {/* Título principal todo blanco */}
        <h1 style={{ fontSize: '3rem', fontWeight: 600, margin: '0 0 20px 0', letterSpacing: '-0.5px', color: '#ffffff' }}>
          ¿Quiénes somos?
        </h1>
      ...
      <section style={{ maxWidth: '1440px', margin: '90px auto 0 auto', padding: '0 24px' }}>
        <div style={{ backgroundColor: '#141518', border: '1px solid #27272a', borderRadius: '28px', padding: '48px 36px', overflow: 'hidden' }}>
          ...
          <div className="salon-grid">
            ...
            <div>
              <div style={{ display: 'inline-flex', alignItems: 'center', backgroundColor: 'rgba(237, 28, 36, 0.1)', border: '1px solid rgba(237, 28, 36, 0.3)', color: '#ED1C24', padding: '5px 16px', borderRadius: '30px', fontSize: '0.78rem', fontWeight: 700, letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '16px' }}>
                SALÓN COMERCIAL
              </div>
