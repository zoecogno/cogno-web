...
export default function Home() {
  ...
  return (
    <div style={{ backgroundColor: '#0B0C0E', minHeight: '100vh', color: '#ffffff', paddingBottom: '80px', overflowX: 'hidden' }}>
      ...
      <style>{`
        /* --- ESCRITORIO (ESCALA INTERMEDIA CALIBRADA) --- */
        .hero-title {
          font-size: 2.35rem;
          font-weight: 600;
      ...
      <section style={{ padding: '20px 20px 10px 20px', textAlign: 'center', maxWidth: '980px', margin: '0 auto' }}>
        ...
        <div className="hero-badge" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', backgroundColor: 'rgba(237, 28, 36, 0.08)', border: '1px solid rgba(237, 28, 36, 0.4)', color: '#ED1C24', padding: '6px 16px', borderRadius: '30px', fontSize: '0.78rem', fontWeight: 700, letterSpacing: '0.6px', marginBottom: '12px', textTransform: 'uppercase' }}>
          <span>🛡️</span>
          <span>TRAYECTORIA Y COMPROMISO</span>
        </div>

        <p className="hero-desc" style={{ color: '#F4F4F5', fontSize: '1rem', maxWidth: '780px', margin: '0 auto 8px auto', lineHeight: 1.5, fontWeight: 400 }}>
        ...
        <p className="hero-sub" style={{ color: '#a1a1aa', fontSize: '0.9rem', margin: '0 auto 16px auto', fontWeight: 400 }}>
        ...
        <div className="two-cards-grid">
          ...
          <div className="interactive-card">
            ...
            <div className="card-body-content">
              <div>
                <h2 className="card-main-title" style={{ fontSize: '1.35rem', fontWeight: 700, color: '#ffffff', margin: '0 0 6px 0' }}>
                  Unidades 0KM
                </h2>
        ...
        <div className="identity-grid">
          <div className="identity-card">
            ...
            <div className="identity-overlay">
              <h3 style={{ fontSize: '1.1rem', fontWeight: 600, margin: 0, color: '#ffffff', lineHeight: 1.35 }}>Garantía propia en las unidades usadas</h3>
            </div>
          </div>
          ...
          <div className="identity-card">
            ...
            <div className="identity-overlay">
              <h3 style={{ fontSize: '1.1rem', fontWeight: 600, margin: 0, color: '#ffffff', lineHeight: 1.35 }}>Atención personalizada de principio a fin</h3>
            </div>
          </div>
          ...
          <div className="identity-card">
            ...
            <div className="identity-overlay">
              <h3 style={{ fontSize: '1.1rem', fontWeight: 600, margin: 0, color: '#ffffff', lineHeight: 1.35 }}>+35 años de trayectoria en el sector</h3>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ maxWidth: '1280px', margin: '45px auto 0 auto', padding: '0 24px' }}>
        <div className="metrics-grid">
          ...
          <div className="metric-box">
            <div className="metric-num" style={{ fontWeight: 700, color: '#ED1C24', lineHeight: 1, marginBottom: '6px' }}>16+</div>
            <div className="metric-label" style={{ fontSize: '0.98rem', fontWeight: 600, color: '#ffffff', marginBottom: '3px' }}>Marcas 0km</div>
            <div className="metric-sub" style={{ fontSize: '0.84rem', color: '#d4d4d8', fontWeight: 400 }}>Gama completa</div>
          </div>
        </div>
      </section>
      ...
      {/* 5. FINANCIACIÓN */}
      <section style={{ maxWidth: '1280px', margin: '50px auto 0 auto', padding: '0 24px' }}>
        <div className="finance-box" style={{ backgroundColor: '#141518', border: '1px solid #27272a', borderRadius: '20px', padding: '40px 30px', textAlign: 'center' }}>
          ...
          <h2 className="finance-title" style={{ fontWeight: 600, margin: '0 0 12px 0' }}>
          ...
          <a 
            ...
            style={{ display: 'inline-block', backgroundColor: '#ED1C24', color: '#ffffff', padding: '13px 30px', borderRadius: '10px', fontWeight: 700, fontSize: '0.92rem', textDecoration: 'none' }}
          >
      ...
      {/* 6. RESEÑAS */}
      <section style={{ maxWidth: '1280px', margin: '50px auto 0 auto', padding: '0 24px', boxSizing: 'border-box' }}>
        <div style={{ textAlign: 'center', marginBottom: '24px' }}>
          <span style={{ fontSize: '0.82rem', fontWeight: 700, color: '#ED1C24', letterSpacing: '2px', textTransform: 'uppercase' }}>
            TESTIMONIOS REALES
          </span>
          <h2 className="section-title" style={{ margin: '4px 0 0 0', color: '#ffffff' }}>
        ...
        <div 
          ...
          style={{ display: 'flex', gap: '16px', overflowX: 'auto', scrollSnapType: 'x mandatory', paddingBottom: '14px', width: '100%', boxSizing: 'border-box' }}
        >
          {reviews.map((r, i) => (
            <div key={i} className="review-carousel-item" style={{ boxSizing: 'border-box' }}>
              <div>
                <p style={{ fontSize: '0.94rem', color: '#F4F4F5', fontStyle: 'italic', lineHeight: 1.55, margin: '0 0 14px 0', fontWeight: 400 }}>
                  "{r.text}"
                </p>
                <div style={{ color: '#F59E0B', fontSize: '0.95rem', marginBottom: '10px' }}>
                  {'★'.repeat(r.rating)}
                </div>
              </div>

              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', borderTop: '1px solid #27272a', paddingTop: '10px' }}>
