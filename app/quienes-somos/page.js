...
export default function QuienesSomos() {
  return (
    <div style={{ backgroundColor: '#0B0C0E', minHeight: '100vh', color: '#ffffff', paddingBottom: '90px', overflowX: 'hidden' }}>
      ...
      <section style={{ padding: '45px 20px 20px 20px', textAlign: 'center', maxWidth: '1050px', margin: '0 auto' }}>
        ...
        {/* Título principal */}
        <h1 className="hero-qs-title" style={{ fontSize: '3.1rem', fontWeight: 600, margin: '0 0 16px 0', letterSpacing: '-0.5px', color: '#ffffff', lineHeight: 1.15 }}>
          ¿Quiénes <span style={{ color: '#ED1C24' }}>somos?</span>
        </h1>

        {/* Badge rojo */}
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', backgroundColor: 'rgba(237, 28, 36, 0.08)', border: '1px solid rgba(237, 28, 36, 0.4)', color: '#ED1C24', padding: '8px 20px', borderRadius: '30px', fontSize: '0.82rem', fontWeight: 700, letterSpacing: '0.8px', marginBottom: '22px', textTransform: 'uppercase' }}>
          <span>🛡️</span>
          <span>TRAYECTORIA Y COMPROMISO</span>
        </div>

        {/* Párrafos principales */}
        <div style={{ maxWidth: '880px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '14px' }}>
      ...
      <div style={{ maxWidth: '1540px', margin: '35px auto 0 auto', padding: '0 24px' }}>
        ...
        <div style={{ maxWidth: '880px', margin: '40px auto 0 auto', textAlign: 'center', display: 'flex', flexDirection: 'column', gap: '14px' }}>
          <p style={{ fontSize: '1.05rem', color: '#ffffff', lineHeight: 1.7, margin: 0, fontWeight: 300 }}>
        ...
        <div className="vision-grid">
          ...
          <div className="vision-card">
            ...
            <div className="vision-content">
              ...
              <h3 style={{ fontSize: '1.6rem', fontWeight: 600, margin: '6px 0 10px 0', color: '#ffffff' }}>Seguridad, respaldo y tranquilidad</h3>
          ...
          <div className="vision-card">
            ...
            <div className="vision-content">
              ...
              <h3 style={{ fontSize: '1.6rem', fontWeight: 600, margin: '6px 0 10px 0', color: '#ffffff' }}>El referente indiscutido en la región</h3>
              <p style={{ fontSize: '0.98rem', color: '#ffffff', lineHeight: 1.6, margin: 0, fontWeight: 300 }}>
        ...
        <div className="values-grid-2x2">
          ...
          <div className="value-card">
            ...
            <div>
              ...
              <p style={{ fontSize: '0.96rem', color: '#ffffff', lineHeight: 1.6, margin: 0, fontWeight: 300 }}>
        ...
        <div className="salon-card-box" style={{ backgroundColor: '#141518', border: '1px solid #27272a', borderRadius: '26px', padding: '38px 30px' }}>
          ...
          <div className="salon-grid">
            ...
            <div>
              ...
              <p style={{ fontSize: '0.98rem', color: '#ffffff', lineHeight: 1.6, margin: '0 0 20px 0', fontWeight: 300 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(170px, 1fr))', gap: '12px' }}>
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer" 
                  style={{ backgroundColor: '#1F2024', border: '1px solid #333', color: '#ffffff', padding: '12px 24px', borderRadius: '10px', fontWeight: 600, fontSize: '0.9rem', textDecoration: 'none', textAlign: 'center' }}
                >
                  Hablar por WhatsApp
                </a>
              </div>
